...
// icon image.gif
import image from "./img/icon-17.gif";
...
const iconsInputs = [
    createData(
        17,
        "God of all ages",
        "If you are finding it difficult to understand the concept of a modern prophet. you are finding it difficult to grasp the concept of a modern god.",
        "icons © A.Lipede"),
];
