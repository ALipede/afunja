...
// icon image.gif
import image from "./img/icon-2.gif";
...
const iconsInputs = [
    createData(
        2,
        "Time here now there",
        "Now is the Time to be here. thus it is Time for Now to be there. here Now is no Time there and there Now is Now Time here. it is Now Time to be here.",
        "icons © A.Lipede"),
];
