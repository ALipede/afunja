...
// icon image.gif
import image from "./img/icon-7.gif";
...
const iconsInputs = [
    createData(
        7,
        "Shadows of good",
        "The sun does not see the effect of its light on shadows. Neither does a good deed see the effects of its act on the shadows of our sin.",
        "icons © A.Lipede"),
];
