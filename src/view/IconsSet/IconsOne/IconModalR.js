...
// icon image.gif
import image from "./img/icon-18.gif";
...
const iconsInputs = [
    createData(
        18,
        "Hearts destiny-nation",
        "There is a beautiful earth lurking within every beautiful heart. Such that the only beautiful places left to travel are the ones we create out of our hearts.",
        "icons © A.Lipede"),
];
