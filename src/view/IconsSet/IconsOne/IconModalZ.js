...
// icon image.gif
import image from "./img/icon-26.gif";
...
const iconsInputs = [
    createData(
        26,
        "Zion",
        "In making one land holy another is made unholy in effect. Zion is not a physical plain but a spiritual height. In god there is no evil is knowing that all land is holy.",
        "icons © A.Lipede"),
];
