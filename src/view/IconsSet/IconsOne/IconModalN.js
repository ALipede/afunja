...
// icon image.gif
import image from "./img/icon-14.gif";
...
const iconsInputs = [
    createData(
        14,
        "Fate of faith",
        "Some people may find it difficult to believe that god is everything that ever is. Ironically a good way to find god is to try hiding from god. So when I found myself in hell I found god there with me. It was then I realized that I was in heaven all along. I have faith in the fate I share with god. That I am in god and god is in me.",
        "icons © A.Lipede"),
];
