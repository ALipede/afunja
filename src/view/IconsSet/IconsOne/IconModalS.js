...
// icon image.gif
import image from "./img/icon-19.gif";
...
const iconsInputs = [
    createData(
        19,
        "Unidentified Faithful Objects",
        "We would be foolish to believe that we are the only species in the universe that believe in one God.",
        "icons © A.Lipede"),
];
