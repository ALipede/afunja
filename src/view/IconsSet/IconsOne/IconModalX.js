...
// icon image.gif
import image from "./img/icon-24.gif";
...
const iconsInputs = [
    createData(
        ...
        "From the beginning of time I have never followed established ways but have established ways which can lead us out of our present establishments.",
        "icons © A.Lipede"),
];
