...
// icon image.gif
import image from "./img/icon-22.gif";
...
const iconsInputs = [
    createData(
        22,
        "Jez it's us Christ",
        "We all have Christ in us. Jez not Jesus Christ but Christ. Jesus was a Christ and so are we if only we know it. The Christ is the Buddha in every body.",
        "icons © A.Lipede"),
];
