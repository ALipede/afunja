...
// icon image.gif
import image from "./img/icon-20.gif";
...
const iconsInputs = [
    createData(
        20,
        "We-men",
        "The woman we see in women is the wo-man we see in we-men. I see a very beautiful man in every woman. The question we-men must ask is, why is the wo-man in most men such a bitch?.",
        "icons © A.Lipede"),
];
