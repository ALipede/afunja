...
// icon image.gif
import image from "./img/icon-4.gif";
...
const iconsInputs = [
    createData(
        4,
        "The ’For giving gift’ of Forgiven Angels",
        "I Am always and in all ways a ForGiving God for I forever Give. For you Give unto others, that which you wish to be For-Given unto you; for all creation Is created unto you forever as For-Given, Giving back to all creation creative, Is to be a For Giving gift For-Given. We Give to others that which we have been For-Given and we are Given of others that which we are Here For. For Giving.",
        "icons © A.Lipede"),
];
