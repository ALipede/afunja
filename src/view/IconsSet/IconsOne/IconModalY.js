...
// icon image.gif
import image from "./img/icon-25.gif";
...
const iconsInputs = [
    createData(
        25,
        "Choice of life",
        "Rather than being the chosen one. Be the choosing one. Don't live a life chosen for you but instead live one that you are choosing for yourself.",
        "icons © A.Lipede"),
];
