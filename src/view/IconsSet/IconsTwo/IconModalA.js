...
// icon image.gif
import image from "./img/icon-57.gif";
...
const iconsInputs = [
    createData(
        1,
        "The Devil",
        "The Devil must be a good ally if ever there was such a being. The Devil does not tell us what to do but will always take the blame.",
        "icons © A.Lipede"),
];
