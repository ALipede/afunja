...
// icon image.gif
import image from "./img/icon-65.gif";
...
const iconsInputs = [
    createData(
        9,
        "Believer",
        "Believers believe in the belief that bears a vision of the heaven they hold. It is hard for believers to believe in heaven on earth. I do not believe in the belief of god alone but have faith in god beyond belief.",
        "icons © A.Lipede"),
];
