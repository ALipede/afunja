...
// icon image.gif
import image from "./img/icon-61.gif";
...
const iconsInputs = [
    createData(
        5,
        "Starlight",
        "Our souls are created not out of constellation of the stars, but the stars are created through the constellation of our starlight souls.",
        "icons © A.Lipede"),
];
