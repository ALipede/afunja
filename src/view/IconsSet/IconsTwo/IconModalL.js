...
// icon image.gif
import image from "./img/icon-68.gif";
...
const iconsInputs = [
    createData(
        12,
        "Divine food",
        "All the taste we wish for in heaven are here on earth. To wish for a more divine meal than that on earth surely you haven't said your grace.",
        "icons © A.Lipede"),
];
