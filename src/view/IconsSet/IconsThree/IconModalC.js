...
// icon image.gif
import image from "./img/icon-31.gif";
...
const iconsInputs = [
    createData(
        3,
        "Heaven's behaviour",
        "From God a word as swift as a sword will change the world. In God's tomorrow there's no human sorrow but spirits to follow into heaven's city and creative simplicity. In the most holy capacity of life's most peaceful inner most beautiful satisfaction in full, will come a saviour with heaven's flavour and God's behaviour.",
        "icons © A.Lipede"),
];
