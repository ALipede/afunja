...
// icon image.gif
import image from "./img/icon-30.gif";
...
const iconsInputs = [
    createData(
        ...
        "Elements with no sentiments, commitments with appointments, excitement from enlightenment, to say all these things were meant, for love to cement a permanent and thorough judgement. Let the elements and our sentiments be committed to love's appointment, with destiny's excitement and life's enlightenment.",
        "icons © A.Lipede"),
];
