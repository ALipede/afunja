...
// icon image.gif
import image from "./img/icon-52.gif";
...
const iconsInputs = [
    createData(
        24,
        "The Earth",
        "The kingdom of heaven is almost complete. Heaven is built in the hearts of spirits so their souls can walk the Earth. Their minds are free to worship God, their needs are hidden in creation's thoughts, such that only their love can find the creative kingdom of a tangible God.",
        "icons © A.Lipede"),
];
