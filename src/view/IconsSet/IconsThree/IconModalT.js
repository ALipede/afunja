...
// icon image.gif
import image from "./img/icon-48.gif";
...
const iconsInputs = [
    createData(
        20,
        "In the style of a mentor",
        "Tailors of failure making traitors. Dictators are sailors on a sea of failure. Orators are actors in a play called failure. Tailors of failure faking victors. Creation is the actor in every mentor.",
        "icons © A.Lipede"),
];
