...
// icon image.gif
import image from "./img/icon-35.gif";
...
const iconsInputs = [
    createData(
        7,
        "I keep within the sight of my eyes",
        "I am free to feed my material needs within the portion of my inner mansion. Built without patriotic intention. I am free from creed and material greed with no notion for nation and no garments adorned. I am free from breed a soulful seed. An unchanging I within the sight of my eyes.",
        "icons © A.Lipede"),
];
