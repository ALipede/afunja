...
// icon image.gif
import image from "./img/icon-34.gif";
...
const iconsInputs = [
    createData(
        6,
        "Matriarchal materialization",
        "In God our master is the maternal matter, in which all things matter to warrantise, the mathesis of our mater's matrix.",
        "icons © A.Lipede"),
];
