...
// icon image.gif
import image from "./img/icon-33.gif";
...
const iconsInputs = [
    createData(
        5,
        "Flute",
        "Life is blowing an eternal song through our souls. Like a flute blown upon our breath its melody is a sign of a lengthy life.",
        "icons © A.Lipede"),
];
