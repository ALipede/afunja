...
// icon image.gif
import image from "./img/icon-32.gif";
...
const iconsInputs = [
    createData(
        4,
        "Cruise deluxe",
        "On deck with the cox out at sea I looked to the skies and the jowing stars. So with luck I try to find every reason why. Why there's an angel with a vox prying and shy and a lady like a fox crying but sly. As stupid as an ox I stand like a rex erect and vexed, busting with lust trying to tame the dame with the brightest lux.",
        "icons © A.Lipede"),
];
