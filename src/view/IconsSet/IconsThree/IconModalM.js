...
// icon image.gif
import image from "./img/icon-41.gif";
...
const iconsInputs = [
    createData(
        13,
        "Rebirth",
        "When a child is born, we feel a new world return in the entity of a tiny new spirit, resting upon the soul of an old life. Reminding us that the future can be reborn in the past of an old spirit with the thoughts of tomorrow's generation - Welcoming Sofia Dati-Okigbo",
        "icons © A.Lipede"),
];
