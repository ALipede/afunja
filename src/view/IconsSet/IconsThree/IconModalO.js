...
// icon image.gif
import image from "./img/icon-43.gif";
...
const iconsInputs = [
    createData(
        15,
        "Invalid invasion",
        "The expensive expansion of constructive destruction, must be mathematically political to be impressive and at the same time oppressive, through which the extension of rhetoric tension on a political platform, becomes nationally and intentionally an act of putting terror and bringing horror to the accidence of innocence.",
        "icons © A.Lipede"),
];
