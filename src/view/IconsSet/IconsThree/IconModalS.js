...
// icon image.gif
import image from "./img/icon-47.gif";
...
const iconsInputs = [
    createData(
        19,
        "Art",
        "Art is the joy of being alive. Music is the melody of its continuity. Dance is an assurance of its tangibility. Art is an image in the mirror of making love",
        "icons © A.Lipede"),
];
