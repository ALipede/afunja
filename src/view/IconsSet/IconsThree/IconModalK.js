...
// icon image.gif
import image from "./img/icon-39.gif";
...
const iconsInputs = [
    createData(
        11,
        "Our spirit is the axis of the world",
        "The world is our freedom. In the heart of our spirits lies the existence of the earth. To whom do we give glory for the power of the eye but God?",
        "icons © A.Lipede"),
];
