...
// icon image.gif
import image from "./img/icon-50.gif";
...
const iconsInputs = [
    createData(
        22,
        "Heavy lies fly short distances",
        "Our truths are wings with feathers for all weather. The light-hearted in truthful fitness fly wordy journeys the furthest.",
        "icons © A.Lipede"),
];
