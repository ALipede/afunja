...
// icon image.gif
import image from "./img/icon-49.gif";
...
const iconsInputs = [
    createData(
        21,
        "Neighbours",
        "I pray fruit trees grow between you and I and not walls, so that the seeds of sweet fruits fall from our mouths in our friendly garden.",
        "icons © A.Lipede"),
];
