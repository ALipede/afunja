...
// icon image.gif
import image from "./img/icon-45.gif";
...
const iconsInputs = [
    createData(
        17,
        "Thinking thing",
        "Love is anything to everything, a smile is everything to anything, life is something with everything, we are anything we make of something.",
        "icons © A.Lipede"),
];
