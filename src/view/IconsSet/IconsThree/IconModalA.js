...
// icon image.gif
import image from "./img/icon-29.gif";
...
const iconsInputs = [
    createData(
        1,
        "Wisdom",
        "All things are written to be understood but not all things are understandable. Because the wise man does not know more than the fool, the fool will one day know what the wise man knows. dedicated to Martin Luther King Jnr",
        "icons © A.Lipede"),
];
