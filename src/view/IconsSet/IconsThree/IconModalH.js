...
// icon image.gif
import image from "./img/icon-36.gif";
...
const iconsInputs = [
    createData(
        8,
        "Dreams",
        "Our mind is a flame that lights up a bridge between dreams in our reality and realities in our dreams. Our dreams are guardians of our sanity in this powerful reality.",
        "icons © A.Lipede"),
];
