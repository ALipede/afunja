...
import BioImgSix from "./../../assets/img/bio/bio-6.jpg";
...
const afunjaBioProps = {
  ...
  CMarchan: {
    ...
    src: BioImgSix,
    name: "Cutty Marchan",
    bio: "Keyboardist and groove specialist. Cutty recently released 'Ariapita Avenue' on SoundCloud Feb 2023.",
    numKey: 6,
    link: "https://m.soundcloud.com/cuttymarchan/ariapita-avenue",
    linkTag: "'Ariapita Avenue' on SoundCloud.",
  },
  BIdowu: {
    alt: "Biola Idowu",
    src: BioImgThree,
  ...
  render() {
    return (
      <ShowMoreText
        ...
        expanded={false}
      >
        Afolabi Lipede | Flame music producer, bass guitarist, singer and song
        writer. Mark Christopher music director and guitarist. Flame's
        innovative and unique style engages bass harmonics in complex chord
        structures with an underlying bass riff. From this style has evolved an
        original style of music: AFUNJA, meaning African FUNk and JAzz. Solid
        and mesmerising, this music evokes a feeling of a colourful world
        culture. You can hear this unique style on '
        <a href="https://soundcloud.com/afunja-music/free" target="_blank">
          FREE
        </a>
        ' <em>SoundCloud</em>.<br />
        <br />
        Afunja Music Publishing Ltd <sup>Ⓟ</sup> member of ASCAP, Tunecore,
        Amuse, Songtrust and PPL.
      </ShowMoreText>
    );
  }
}
    ...
    <div className={classes.root}>
      ...
      {Object.keys(afunjaBioProps).map((key) => (
        <Accordion key={afunjaBioProps[key].numKey}>
          ...
          >
            <Avatar
              src={afunjaBioProps[key].src}
              alt={afunjaBioProps[key].alt}
            />
            <Typography className={classes.heading}>
              <span className={classes.name}>{afunjaBioProps[key].name}</span>
            </Typography>
          </AccordionSummary>
          <AccordionDetails>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={9}>
                  ...
                  <Typography
                    ...
                    style={{ marginTop: 20 }}
                  >
                    <a href={afunjaBioProps[key].link} target="_blank">
                      {afunjaBioProps[key].linkTag}
                    </a>
                  </Typography>
                </Grid>
              </Grid>
